...
ServerEvents.recipes(event => {
  ...
  event.recipes.thermal.press('9x kubejs:industrial_salt', ['kubejs:block_industrial_salt', 'thermal:press_packing_3x3_die'])
  .energy(400)
  .id('thermal:compat/press_industrial_salt_packing')

  event.recipes.thermal.press('kubejs:block_industrial_salt', ['9x kubejs:industrial_salt', 'thermal:press_packing_3x3_die'])
  .energy(400)
