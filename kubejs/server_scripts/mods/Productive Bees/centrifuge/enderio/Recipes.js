...
ServerEvents.recipes(event => {
  ...
  // Rewrited recipes
  modsCentrifugeRecipes(event, "productivebees:conductive_alloy", [
    { item: {item: "enderio:conductive_alloy_nugget"}, min: 5, max: 7},
    { item: {tag: "forge:wax"}},
    { fluid: {fluid: "the_bumblezone:honey_fluid_still"}, amount: 50}
  ], "enderio");
  modsCentrifugeRecipes(event, "productivebees:copper_alloy", [
    { item: {item: "enderio:copper_alloy_nugget"}, min: 6, max: 9},
    { item: {tag: "forge:wax"}},
    { fluid: {fluid: "the_bumblezone:honey_fluid_still"}, amount: 50}
  ], "enderio");
  modsCentrifugeRecipes(event, "productivebees:dark_steel", [
    { item: {item: "enderio:dark_steel_nugget"}, min: 2, max: 4},
    { item: {tag: "forge:wax"}},
    { fluid: {fluid: "the_bumblezone:honey_fluid_still"}, amount: 50}
  ], "enderio");
  modsCentrifugeRecipes(event, "productivebees:end_steel", [
    { item: {item: "enderio:end_steel_nugget"}, min: 1, max: 3},
    { item: {tag: "forge:wax"}},
    { fluid: {fluid: "the_bumblezone:honey_fluid_still"}, amount: 50}
  ], "enderio");
  modsCentrifugeRecipes(event, "productivebees:energetic_alloy", [
    { item: {item: "enderio:energetic_alloy_nugget"}, min: 6, max: 8},
    { item: {tag: "forge:wax"}},
    { fluid: {fluid: "the_bumblezone:honey_fluid_still"}, amount: 50}
  ], "enderio")
  modsCentrifugeRecipes(event, "productivebees:infinity", [
    { item: {item: "enderio:grains_of_infinity"}, chance: 75},
    { item: {tag: "forge:wax"}},
    { fluid: {fluid: "the_bumblezone:honey_fluid_still"}, amount: 50}
  ], "enderio")
  modsCentrifugeRecipes(event, "productivebees:pulsating_alloy", [
    { item: {item: "enderio:pulsating_alloy_nugget"}, min: 1, max: 12},
    { item: {tag: "forge:wax"}},
    { fluid: {fluid: "the_bumblezone:honey_fluid_still"}, amount: 50}
  ], "enderio")
  modsCentrifugeRecipes(event, "productivebees:redstone_alloy", [
    { item: {item: "enderio:redstone_alloy_nugget"}, min: 3, max: 8},
    { item: {tag: "forge:wax"}},
    { fluid: {fluid: "the_bumblezone:honey_fluid_still"}, amount: 50}
  ], "enderio")
  modsCentrifugeRecipes(event, "productivebees:soularium", [
    { item: {item: "enderio:soularium_nugget"}, min: 5, max: 5},
    { item: {tag: "forge:wax"}},
    { fluid: {fluid: "the_bumblezone:honey_fluid_still"}, amount: 50}
  ], "enderio")
  modsCentrifugeRecipes(event, "productivebees:vibrant_alloy", [
