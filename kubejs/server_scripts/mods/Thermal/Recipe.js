...
ServerEvents.recipes(event => {
    ...
    materials.forEach(material => {
        event.recipes.thermal.press('3x kubejs:thermal_coin', [`#forge:ingots/${material}`, 'thermal:press_coin_die']).energy(800)
    });

    function coin_maker(coin, material){
        event.recipes.thermal.press(coin, [material, 'thermal:press_coin_die']).energy(800)
    }
