...
if (Platform.isLoaded('botanypotstiers')) {
    ...
    ServerEvents.recipes(event => {
        ...
        const types = [
            'terracotta', 'terracotta_hopper', 'concrete', 'concrete_hopper', 'glazed_terracotta', 'glazed_terracotta_hopper'
        ]; // Defining types
        // Elite Botany Pot
    ...
    console.log("Botanypotstiers compat scripts successfully loaded!")
} else { console.log("Botanypotstiers was not found, skipping its compat scripts.") }