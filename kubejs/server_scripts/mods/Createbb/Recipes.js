...
ServerEvents.recipes(event => {
  ...
  event.recipes.create.mixing([Fluid.of('createbb:methanol', 50)], [Fluid.of('mekanism:hydrogen', 100), 'minecraft:coal', 'createbb:copper_zinc_catalyst']).id('kubejs:createbb/methanol_mixing') // Methanol Mixing
  event.recipes.create.mixing([Fluid.of('mekanism:oxygen', 5), Fluid.of('mekanism:hydrogen', 10)], [Fluid.of('minecraft:water', 30), 'minecraft:coal', 'createbb:copper_zinc_catalyst']).heated().id('kubejs:createbb/water_mix_hydrodistillation') //Water Mix-Hydrodistillation
